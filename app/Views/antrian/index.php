                        ...
                        <div class="features-wrap">
                            ...
                            <div class="feature is-revealing">
                                ...
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm">Antrian ini untuk pelayanan customer Service</p>
                                </div>
                                </a>
                            </div>
                            <div class="feature is-revealing">
                                <a href="<?php echo base_url('antrian/pg/5'); ?>">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <svg width="48" height="48" xmlns="http://www.w3.org/2000/svg">
                                            <defs>
                                    ...
                                    <p class="text-sm">Antrian ini di gunakan untuk layanan pengaduan.</p>
                                </div>
                                </a>
                            </div>
                            <div class="feature is-revealing">
                                ...
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm">Antrian ini di gunakan untuk Permohonan Baru.</p>
                                </div>
                                </a>
                            </div>
                            <div class="feature is-revealing">
                                <a href="<?php echo base_url('antrian/png/7'); ?>">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <svg width="48" height="48" xmlns="http://www.w3.org/2000/svg">
                                            <defs>
                                    ...
                                    <p class="text-sm">Antrian ini di gunakan untuk perpanjangan.</p>
                                </div>
                                </a>
                            </div>
                        </div>
        ...
        <footer class="site-footer text-light">
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    ...
                    <div class="footer-copyright">&copy; 2021 Rahmat Hasibuan, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
